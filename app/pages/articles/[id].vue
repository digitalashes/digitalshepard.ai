        ...
        <template #right>
            <u-page-aside :ui="{ root: 'lg:col-span-3!' }">
                ...
                <u-field-group class="w-full">
                    <u-button @click="share" label="Share this article" icon="material-symbols:share" variant="subtle" color="neutral" class="grow" />
            ...
            <div class="flex items-end flex-wrap gap-4 justify-between mt-4">
                ...
                <div class="flex flex-row items-center gap-4">
                    <p class="flex flex-row items-center gap-1 typ-sublabel">
                        <icon name="material-symbols:calendar-today-rounded" class="text-primary" /> {{ formatDate(data?.date) }}
                    </p>
                    <p class="flex flex-row items-center gap-1 typ-sublabel"><icon name="material-symbols:alarm-rounded" class="text-primary" /> {{ readingTime(data?.rawbody) }}</p>
                </div>
            </div>
        </u-page-header>
